...
def load_model_and_scaler():
    ...
    model = tf.keras.models.load_model('E:\Bangkit\Capstone_Project_Bangkit\model_disaster_risk.h5')  # Ubah dengan path model Anda
    scaler = joblib.load('E:/Bangkit/Capstone_Project_Bangkit/scaler.pkl')  # Ubah dengan path scaler Anda
    return model, scaler
